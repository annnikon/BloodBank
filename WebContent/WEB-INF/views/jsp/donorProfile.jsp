        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#recipients">Find recipients</a>
                    </li>
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>What is required for blood donation?</h4>
                                    
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">You should pass a test for: </p>
                                  <p> Hepatitis B Surface Antigen <br/>
Antibody to Hepatitis C<br/>
Antibody to HIV, usually subtypes 1 and 2 <br/>
 Serologic test for Syphilis <br/> </p>
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    ...
                                    <h4 class="subheading">See possible dates in "Events"</h4>
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">Not more often than once per 30 days.</p>
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>What benefits will I get after donation?</h4>
                                
                                </div>
                                <div class="timeline-body">
                                    <p class="text-muted">You will not get any money (donation is free). 
                                    <br/>But you will get freedom from education or work for 3 days and tea with sweats from organizers!</p>
                                </div>
                            </div>
                        </li>
    ...
    <section id="events" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Your schedule for donations</h2>
...
<hr>
  <h1>The nearest dates of possible donations for you:</h1>
           <table class="table-hover" width="40%">
